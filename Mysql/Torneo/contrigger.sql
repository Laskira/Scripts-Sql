...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-09-2019 a las 06:45:33
...
INSERT INTO `tblpersonas` (`PkId`, `FkId_TblTipoDocumento`, `FkId_TblRol`, `P_Nombre`, `S_Nombre`, `P_Apellido`, `S_Apellido`, `FecNacimiento`, `FkId_TblSexo`, `FkId_TblRh`, `FkId_TblEps`, `Movil`, `Correo`, `IdCreador`, `Foto`) VALUES
('779803', 3, 1, 'Jamir', '', 'Berrio', '', '1978-08-02', 2, 3, 2, '312323343', 'jamir@gmail.com', '', '');

--
-- Disparadores `tblpersonas`
--
DELIMITER $$
CREATE TRIGGER `TblUsuarios` AFTER INSERT ON `tblpersonas` 
FOR EACH ROW INSERT INTO TblUsuarios(PkId_TblPersonas, Correo, 
Contrasenia, FkId_TblEstado, FkId_TblRol, FechaCreacionUsu)
...
CREATE TABLE `tblusuarios` (
  ...
  `FkId_TblEstado` int(11) NOT NULL,
  `FkId_TblRol` int(11) NOT NULL,
  `FechaCreacionUsu` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `tblusuarios` (`PkId_TblPersonas`, `Correo`, `Contrasenia`, `FkId_TblEstado`, `FkId_TblRol`, `FechaCreacionUsu`) VALUES
('779803', 'jamir@gmail.com', '779803', 1, 1, '2019-09-02 23:19:49');
...
ALTER TABLE `tblpersonas`
  ...
  ADD CONSTRAINT `tblpersonas_ibfk_5` FOREIGN KEY (`FkId_TblRol`) REFERENCES `tblrol` (`PkId`);
